...
const imageProcess = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { picName, h, w } = req.params;
        if (fs_1.default.existsSync(`images/${picName}_${h}_${w}.jpg`)) {
            res.sendFile(`/${picName}_${h}_${w}.jpg`, {
                root: path_1.default.join('./images'),
            });
        }
        else {
